...
def draw(draw_info, algo_name, ascending):
    ...
    sorting = draw_info.FONT.render("B - Bubble Sort | I - Insertion Sort | M - Merge Sort | Q - Quick Sort",
                                    1, draw_info.BLACK)
...
def draw_list(draw_info, color_positions={}, clear_bg=False):
    ...
    """Draws all elements in lst in proper height and width.
    highlights the two current elements in red and green.
    """
    lst = draw_info.lst
